...
const ProfilLocataire = props => {
  ...
  const balanceUpdateHandler = () => {
    props.updateTenant(
      props.tenant.id,
      props.tenant.first_name,
      props.tenant.last_name,
      props.tenant.mail_address,
      props.tenant.birth_date,
      props.tenant.gender,
      props.tenant.username,
      props.tenant.password,
      props.tenant.balance + 10,
    );
  };
  return (
    <>
            ...
            <View
              ...
              <View style={styles.row}>
                ...
                <Button
                  ...
                  onPress={balanceUpdateHandler}></Button>
              </View>
            </View>
          </View>
